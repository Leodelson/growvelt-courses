...
await run(["exec","-i",name,"psql","-X","-v","ON_ERROR_STOP=1","-U","postgres","-d","postgres"],await readFile(path.join(root,"supabase","tests","phase2a_exit_controls.sql"),"utf8"));
console.log("PASS Phase 2A organization exit controls on isolated local Supabase");
