...
const mobileInstructorNavigation = [
  ...
  { href: "/dashboard/instructor/courses/new", label: "Create course", mobileLabel: "Create Course", icon: "add-course" as const },
  { href: "https://www.growvelt.com", label: "Jobs", mobileLabel: "Jobs", icon: "jobs" as const, external: true },
...
function WorkspaceLinks({ isInstructor, isAdmin, isCompany, pathname, onNavigate }: WorkspaceAccess & { pathname: string; onNavigate?: () => void }) {
  ...
  return <nav className="workspace-links" aria-label="Available workspaces">
    {isInstructor && <section><p className="eyebrow">{t("nav.instructor")}</p><Link data-tooltip={t("nav.instructor")} onClick={onNavigate} href="/dashboard/instructor" aria-current={isCurrent("/dashboard/instructor") ? "page" : undefined}><LearningIcon name="instructor-review" /><span>{t("nav.instructor")}</span></Link><Link data-tooltip={t("nav.courses")} onClick={onNavigate} href="/dashboard/instructor/courses" aria-current={isCurrent("/dashboard/instructor/courses") ? "page" : undefined}><LearningIcon name="courses" /><span>{t("nav.courses")}</span></Link><Link data-tooltip="Organizations" onClick={onNavigate} href="/dashboard/instructor/organizations" aria-current={isCurrent("/dashboard/instructor/organizations") ? "page" : undefined}><LearningIcon name="organization" /><span>Organizations</span></Link><Link data-tooltip="Earnings" onClick={onNavigate} href="/dashboard/instructor/earnings" aria-current={isCurrent("/dashboard/instructor/earnings") ? "page" : undefined}><LearningIcon name="earnings" /><span>Earnings</span></Link><Link data-tooltip="Payout profile" onClick={onNavigate} href="/dashboard/instructor/payout-profile" aria-current={isCurrent("/dashboard/instructor/payout-profile") ? "page" : undefined}><LearningIcon name="payout" /><span>Payout profile</span></Link><Link data-tooltip={t("nav.createCourse")} onClick={onNavigate} href="/dashboard/instructor/courses/new" aria-current={isCurrent("/dashboard/instructor/courses/new") ? "page" : undefined}><LearningIcon name="add-course" /><span>{t("nav.createCourse")}</span></Link></section>}
    {isCompany && <section><p className="eyebrow">Company learning</p><Link data-tooltip="Company learning" onClick={onNavigate} href="/dashboard/company" aria-current={isCurrent("/dashboard/company") ? "page" : undefined}><LearningIcon name="company" /><span>Company learning</span></Link></section>}
    {isAdmin && <section><p className="eyebrow">Admin Reviews</p><Link data-tooltip={t("nav.instructorReviews")} onClick={onNavigate} href="/dashboard/admin/instructors" aria-current={isCurrent("/dashboard/admin/instructors") ? "page" : undefined}><LearningIcon name="instructor-review" /><span>{t("nav.instructorReviews")}</span></Link><Link data-tooltip={t("nav.courseReviews")} onClick={onNavigate} href="/dashboard/admin/courses" aria-current={isCurrent("/dashboard/admin/courses") ? "page" : undefined}><LearningIcon name="course-review" /><span>{t("nav.courseReviews")}</span></Link><Link data-tooltip="Provider verification" onClick={onNavigate} href="/dashboard/admin/providers" aria-current={isCurrent("/dashboard/admin/providers") ? "page" : undefined}><LearningIcon name="provider-verification" /><span>Provider verification</span></Link><Link data-tooltip={t("nav.paymentOperations")} onClick={onNavigate} href="/dashboard/admin/payments" aria-current={isCurrent("/dashboard/admin/payments") ? "page" : undefined}><LearningIcon name="payment-operations" /><span>{t("nav.paymentOperations")}</span></Link><Link data-tooltip="Commercial earnings" onClick={onNavigate} href="/dashboard/admin/commercial" aria-current={isCurrent("/dashboard/admin/commercial") ? "page" : undefined}><LearningIcon name="earnings" /><span>Commercial earnings</span></Link></section>}
  </nav>;
}
...
function MobileWorkspaceLinks({ isAdmin, isInstructor, isCompany, onNavigate }: Pick<WorkspaceAccess, "isAdmin" | "isInstructor" | "isCompany"> & { onNavigate: () => void }) {
  ...
  return <div className="mobile-dashboard-workspaces">
    <section><p className="eyebrow">Learning</p>{navigation.filter((item) => item.href !== "/dashboard" && !item.external && (item.href !== "/dashboard/company" || isCompany)).map((item) => <Link onClick={onNavigate} href={item.href} key={item.href}><LearningIcon name={item.icon} />{t(item.labelKey)}</Link>)}</section>
    {isInstructor && <section><p className="eyebrow">Instructor workspace</p><Link onClick={onNavigate} href="/dashboard/instructor"><LearningIcon name="instructor-review" />{t("nav.instructor")}</Link><Link onClick={onNavigate} href="/dashboard/instructor/organizations"><LearningIcon name="organization" />Organizations</Link><Link onClick={onNavigate} href="/dashboard/instructor/payout-profile"><LearningIcon name="payout" />Payout profile</Link></section>}
    {isAdmin && <section><p className="eyebrow">Admin Reviews</p><Link onClick={onNavigate} href="/dashboard/admin/instructors"><LearningIcon name="instructor-review" />Instructor reviews</Link><Link onClick={onNavigate} href="/dashboard/admin/courses"><LearningIcon name="course-review" />Course reviews</Link><Link onClick={onNavigate} href="/dashboard/admin/providers"><LearningIcon name="provider-verification" />Provider verification</Link><Link onClick={onNavigate} href="/dashboard/admin/payments"><LearningIcon name="payment-operations" />Payment operations</Link><Link onClick={onNavigate} href="/dashboard/admin/commercial"><LearningIcon name="earnings" />Commercial earnings</Link></section>}
  </div>;
}
      ...
      <header className="app-header"><LearningMark href="/dashboard" /><div className="header-tools">
        <div className="mobile-dashboard-control" ref={mobileRef} data-shell-popover>
          ...
          {openPanel === "mobile" && <><button className="mobile-dashboard-backdrop" type="button" aria-label="Close dashboard menu" onClick={() => setOpenPanel(null)} /><aside className="mobile-dashboard-menu" aria-label="Mobile dashboard menu">
            ...
            <nav aria-label="Mobile dashboard links"><Link onClick={() => setOpenPanel(null)} href="/dashboard/profile"><LearningIcon name="profile" />{t("nav.profile")}</Link><Link onClick={() => setOpenPanel(null)} href="/dashboard/settings"><LearningIcon name="settings" />{t("nav.settings")}</Link></nav>
