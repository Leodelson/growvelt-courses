...
function WorkspaceLinks({ isInstructor, isAdmin, pathname, onNavigate }: WorkspaceAccess & { pathname: string; onNavigate?: () => void }) {
  ...
  return <nav className="workspace-links" aria-label="Available workspaces">
    {isInstructor && <section><p className="eyebrow">{t("nav.instructor")}</p><Link data-tooltip={t("nav.instructor")} onClick={onNavigate} href="/dashboard/instructor" aria-current={isCurrent("/dashboard/instructor") ? "page" : undefined}><LearningIcon name="instructor-review" /><span>{t("nav.instructor")}</span></Link><Link data-tooltip={t("nav.courses")} onClick={onNavigate} href="/dashboard/instructor/courses" aria-current={isCurrent("/dashboard/instructor/courses") ? "page" : undefined}><LearningIcon name="courses" /><span>{t("nav.courses")}</span></Link><Link data-tooltip="Earnings" onClick={onNavigate} href="/dashboard/instructor/earnings" aria-current={isCurrent("/dashboard/instructor/earnings") ? "page" : undefined}><LearningIcon name="earnings" /><span>Earnings</span></Link><Link data-tooltip="Payout profile" onClick={onNavigate} href="/dashboard/instructor/payout-profile" aria-current={isCurrent("/dashboard/instructor/payout-profile") ? "page" : undefined}><LearningIcon name="earnings" /><span>Payout profile</span></Link><Link data-tooltip={t("nav.createCourse")} onClick={onNavigate} href="/dashboard/instructor/courses/new" aria-current={isCurrent("/dashboard/instructor/courses/new") ? "page" : undefined}><LearningIcon name="add-course" /><span>{t("nav.createCourse")}</span></Link></section>}
    {isAdmin && <section><p className="eyebrow">Admin Reviews</p><Link data-tooltip={t("nav.instructorReviews")} onClick={onNavigate} href="/dashboard/admin/instructors" aria-current={isCurrent("/dashboard/admin/instructors") ? "page" : undefined}><LearningIcon name="instructor-review" /><span>{t("nav.instructorReviews")}</span></Link><Link data-tooltip={t("nav.courseReviews")} onClick={onNavigate} href="/dashboard/admin/courses" aria-current={isCurrent("/dashboard/admin/courses") ? "page" : undefined}><LearningIcon name="course-review" /><span>{t("nav.courseReviews")}</span></Link><Link data-tooltip={t("nav.paymentOperations")} onClick={onNavigate} href="/dashboard/admin/payments" aria-current={isCurrent("/dashboard/admin/payments") ? "page" : undefined}><LearningIcon name="payment-operations" /><span>{t("nav.paymentOperations")}</span></Link><Link data-tooltip="Commercial earnings" onClick={onNavigate} href="/dashboard/admin/commercial" aria-current={isCurrent("/dashboard/admin/commercial") ? "page" : undefined}><LearningIcon name="earnings" /><span>Commercial earnings</span></Link></section>}
  </nav>;
}
