...
export function ApplicationStatus({ application }: { application: InstructorApplication | null }) {
  ...
  return <section className="application-status"><p className="eyebrow">Instructor access active</p><h1>You’re approved to teach on Growvelt.</h1><p>Your Instructor workspace is ready. Course creation tools will arrive in the next phase.</p><Link className="button button-primary" href="/instructor">Go to Instructor workspace</Link></section>;
}
