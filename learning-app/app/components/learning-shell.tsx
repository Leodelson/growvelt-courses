...
export function LearningShell({ children }: { children: React.ReactNode }) {
  ...
  return <div className="app-shell">
    ...
    <div className="shell-content"><header className="app-header"><Link href="/dashboard" className="back-link">Learning home</Link><div className="header-tools"><ThemeControl /><SignOutButton /></div></header><main className="dashboard-main">{children}</main></div>
