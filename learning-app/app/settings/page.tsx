...
export default function SettingsPage() {
  return <>
    <header className="dashboard-intro"><div><p className="eyebrow">Settings</p><h1>Your Learning space.</h1><p>Appearance is saved locally on this device. Profile controls will arrive with a later learner-data phase.</p></div></header>
