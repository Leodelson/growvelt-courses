...
export default async function DashboardNewInstructorCoursePage() {
  ...
  return <section className="course-editor-page section-shell"><header className="course-editor-heading"><p className="eyebrow">{text.eyebrow}</p><h1>{text.title}</h1><p>{text.copy}</p></header><CourseDraftForm mode="create" organizations={organizations} /></section>;
}
