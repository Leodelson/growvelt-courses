create or replace function public.fail_paystack_test_learning_attempt (
...
revoke all on function "public"."fail_paystack_test_learning_attempt"(text, text, text) from public;
