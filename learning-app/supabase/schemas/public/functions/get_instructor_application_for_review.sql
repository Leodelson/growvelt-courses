create or replace function public.get_instructor_application_for_review (
...
grant execute on function "public"."get_instructor_application_for_review"(uuid) to "authenticated", "postgres", "service_role";

revoke all on function "public"."get_instructor_application_for_review"(uuid) from public;
