create or replace function public.list_learning_refund_cases (
  p_operator_id uuid,
  p_order_id    bigint default null::bigint
)
  returns table (
    case_id                 bigint,
    order_id                bigint,
...
revoke all on function "public"."list_learning_refund_cases"(uuid, bigint) from public;
