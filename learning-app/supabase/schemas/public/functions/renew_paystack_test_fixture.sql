...
grant execute on function "public"."renew_paystack_test_fixture"(bigint, uuid, timestamp with time zone) to "postgres", "service_role";

revoke all on function "public"."renew_paystack_test_fixture"(bigint, uuid, timestamp with time zone) from public;
