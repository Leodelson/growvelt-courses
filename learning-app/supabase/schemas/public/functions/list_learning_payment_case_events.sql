create or replace function public.list_learning_payment_case_events (
  p_operator_id uuid,
  p_case_id     bigint
)
  returns table (
...
revoke all on function "public"."list_learning_payment_case_events"(uuid, bigint) from public;
