create or replace function public.get_own_paystack_learning_payment_status (
...
revoke all on function "public"."get_own_paystack_learning_payment_status"(text) from public;
