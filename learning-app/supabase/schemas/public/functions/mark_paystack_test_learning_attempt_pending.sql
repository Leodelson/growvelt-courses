create or replace function public.mark_paystack_test_learning_attempt_pending (
...
revoke all on function "public"."mark_paystack_test_learning_attempt_pending"(text) from public;
