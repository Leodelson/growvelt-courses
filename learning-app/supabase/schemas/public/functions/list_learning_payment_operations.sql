create or replace function public.list_learning_payment_operations (
  p_operator_id uuid,
...
revoke all on function "public"."list_learning_payment_operations"(uuid, text, integer) from public;
