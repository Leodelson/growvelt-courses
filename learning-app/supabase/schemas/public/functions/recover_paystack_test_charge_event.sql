...
begin
 ...
 insert into public.learning_audit_events(actor_user_id,actor_role,action,entity_type,entity_id,metadata) values(p_operator_id,'admin_operator','payment_provider_event.reprocessed','payment_provider_event',p_event_id::text,jsonb_build_object('outcome',result_row.outcome));
