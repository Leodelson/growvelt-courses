create or replace function public.get_own_paystack_test_fixture_eligibility (
  p_course_id bigint
)
  returns table (
    eligible   boolean,
...
revoke all on function "public"."get_own_paystack_test_fixture_eligibility"(bigint) from public;
