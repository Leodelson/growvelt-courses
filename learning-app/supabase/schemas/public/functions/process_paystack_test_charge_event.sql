create or replace function public.process_paystack_test_charge_event (
  p_event_id bigint
)
  returns table (
    outcome       text,
...
revoke all on function "public"."process_paystack_test_charge_event"(bigint) from public;
